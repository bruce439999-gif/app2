        ...
        <div>
          ...
          <div className="prose prose-zinc dark:prose-invert">
            <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-4 leading-8">
              你好！我是一个热衷于 Web 开发的小说家。我喜欢写作，并在我的博客上分享我的新作。
            </p>
            <p className="text-lg text-zinc-600 dark:text-zinc-400 mb-4 leading-8">
              我的小说主要是爽文系列，以及未来星际小说，以及部分修仙小说。
            </p>
            <p className="text-lg text-zinc-600 dark:text-zinc-400 leading-8">
              除了写作外，我还喜欢编程，摄影、阅读和旅行。如果你有任何问题或者想和我交流，欢迎随时联系我！
            </p>
          </div>
          <div className="mt-8">
            <h2 className="text-xl font-bold text-zinc-900 dark:text-zinc-50 mb-4">联系方式</h2>
            <ul className="space-y-2 text-zinc-600 dark:text-zinc-400">
              <li>Email: bruce439999@gmail.com</li>
              <li>GitHub: github.com/bruce439999-gif</li>
              <li>Telegram: @bruce43999</li>
            </ul>
          </div>
        </div>
